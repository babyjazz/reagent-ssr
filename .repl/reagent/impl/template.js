...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20205__auto__,writer__20206__auto__,opt__20207__auto__){
return cljs.core._write.call(null,writer__20206__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__19607__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__19607__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__19607__auto__)){
return or__19607__auto__;
} else {
...
var G__23212 = o;
(G__23212[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_23216 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_23216))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_23216)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__19595__auto__ = (node === document.activeElement);
if(and__19595__auto__){
var and__19595__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
if(cljs.core.truth_(and__19595__auto____$1)){
return (typeof value === 'string') && (typeof node_value === 'string');
} else {
return and__19595__auto____$1;
}
} else {
...
if(cljs.core.truth_((function (){var and__19595__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__23219 = jsprops;
(G__23219["defaultValue"] = value);

(G__23219["onChange"] = ((function (G__23219,v,value,on_change){
return (function (p1__23217_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23217_SHARP_);
});})(G__23219,v,value,on_change))
);
...
var vec__23221 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23221,(0),null);
var id = cljs.core.nth.call(null,vec__23221,(1),null);
var class$ = cljs.core.nth.call(null,vec__23221,(2),null);
...
var temp__4427__auto__ = (function (){var G__23225 = cljs.core.meta.call(null,v);
var G__23225__$1 = (((G__23225 == null))?null:reagent.impl.template.get_key.call(null,G__23225));
return G__23225__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__23227_23228 = v;
var G__23227_23229__$1 = (((G__23227_23228 == null))?null:reagent.impl.template.key_from_vec.call(null,G__23227_23228));
var G__23227_23230__$2 = (((G__23227_23229__$1 == null))?null:(jsprops["key"] = G__23227_23229__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__23233 = cljs.core.meta.call(null,argv);
var G__23233__$1 = (((G__23233 == null))?null:reagent.impl.template.get_key.call(null,G__23233));
return G__23233__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__23234 = (((jsprops == null))?{}:jsprops);
(G__23234["key"] = key);
...
var G__23235 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23235;
continue;
}
} else {
...
var n__20510__auto___23236 = a.length;
var i_23237 = (0);
while(true){
if((i_23237 < n__20510__auto___23236)){
(a[i_23237] = reagent.impl.template.as_element.call(null,(a[i_23237])));
...
var a = cljs.core.into_array.call(null,s);
var n__20510__auto___23239 = a.length;
var i_23240 = (0);
while(true){
if((i_23240 < n__20510__auto___23239)){
var val_23241 = (a[i_23240]);
if((cljs.core.vector_QMARK_.call(null,val_23241)) && ((reagent.impl.template.key_from_vec.call(null,val_23241) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23240] = reagent.impl.template.as_element.call(null,val_23241));
...
if(cljs.core.truth_((function (){var and__19595__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__19595__auto__){
return (ctx["no-key"]);
} else {
return and__19595__auto__;
...
var G__23244 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23244) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23244){
